...
#
# # class Vehicle:
# #     def __init__(self, arg_name, arg_wheels, arg_petrol, arg_color, arg_speed):
# #         self.name = arg_name
# #         self.wheels = arg_wheels
# #         self.color = arg_color
# #         self.petrol = arg_petrol
# #         self.speed = arg_speed
# #
# #     def move(self):
# #         print(f"You can start driving your {self.name} at {self.speed}.")
# #
# #     def petrol_warn(self):
# #         if self.petrol > 20:
# #             print("You can drive.")
# #         elif self.petrol > 0:
# #             print("You need to refuel.")
# #         else:
# #             print("You have already stopped, bro.")
# #
# #     def driver(self):
# #         if self.color == 'pink':
# #             print("It's a woman")
