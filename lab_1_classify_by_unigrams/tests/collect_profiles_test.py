...
class CollectProfilesTest(unittest.TestCase):
    ...
    def test_collect_profiles_ideal(self):
        ...
        for expected_dictionary_with_profiles, actual_dictionary_with_profiles in zip(
            expected, actual
        ):
            self.assertEqual(
                expected_dictionary_with_profiles["name"], actual_dictionary_with_profiles["name"]
            )
