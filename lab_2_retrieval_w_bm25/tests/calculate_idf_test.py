...
class CalculateIdfTest(unittest.TestCase):
    ...
    def test_calculate_idf_ideal(self):
        ...
        """
        expected = {
            'upon': 1.8458, 'time': 1.8458, 'tale': 1.8458, 'boy': 1.8458,
            'smart': 1.8458, 'kind': 1.8458, 'stories': 0.0, 'need': 1.8458,
            'told': 1.8458, 'story': 1.8458, 'began': 1.8458, 'coffee': 1.8458,
            'shop': 1.8458, 'across': 1.2238, 'street': 1.2238, 'love': 1.2238,
            'reading': 1.8458, 'writing': 1.8458, 'friend': 1.8458, 'opened': 1.8458,
            'library': 0.7621, 'named': 1.8458, 'function': 1.8458, 'must': 1.8458,
            'output': 1.8458, 'string': 1.8458, 'particular': 1.8458, 'format': 1.8458,
            'beautiful': 1.2238, 'ugly': 1.8458, 'thought': 1.8458, 'saw': 1.8458,
            'ghost': 1.8458, 'cat': 0.7621, 'lived': 1.8458, 'loved': 1.8458
        }
    ...
    def test_calculate_idf_new_tokens(self):
        ...
        """
        expected = {
            'upon': 1.9459, 'time': 1.9459, 'tale': 1.9459, 'boy': 1.9459,
            'smart': 1.9459, 'kind': 1.9459, 'stories': 0.1671, 'need': 1.9459,
            'told': 1.9459, 'story': 1.9459, 'began': 1.9459, 'coffee': 1.9459,
            'shop': 1.9459, 'across': 1.335, 'street': 1.335, 'love': 1.335,
            'reading': 1.9459, 'writing': 1.9459, 'friend': 1.9459, 'opened': 1.9459,
            'library': 0.8873, 'named': 1.9459, 'function': 1.9459, 'must': 1.9459,
            'output': 1.9459, 'string': 1.9459, 'particular': 1.9459, 'format': 1.9459,
            'beautiful': 1.335, 'ugly': 1.9459, 'thought': 1.9459, 'saw': 1.9459,
            'ghost': 1.9459, 'cat': 0.8873, 'lived': 1.9459, 'loved': 1.9459,
            'completely': 1.9459, 'new': 1.9459, 'document': 1.9459}

        actual = calculate_idf(
            self.vocabulary,
            self.tokenized_documents + [['completely', 'new', 'document']]
        )
        for token, frequency in actual.items():
            self.assertAlmostEqual(expected[token], frequency, delta=1e-4)
    ...
    def test_calculate_idf_bad_input(self):
        ...
        """
        expected = None
        bad_vocabulary_inputs = [None, True, 42, 3.14, (), 'document', {},
                                 [], [False, 5, {}, 'no!']]
        bad_documents_inputs = [None, True, 42, 3.14, (), 'document', {}, [],
